...
pipeline and compares it **byte-for-byte** against a committed reference (**42–53 min**, measured seven
times: 42:28, 43:28, 43:50, 44:32, ~50:00, 52:35, 53:10 — budget for the top of that range, not the bottom). Nothing here is
